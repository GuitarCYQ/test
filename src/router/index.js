...
import Release from '../views/activity/release'
import Dynamic from '../views/activity/dynamic'
...
export const asyncRoutes = [
...

  {
    path: '/dynamic',
    name: 'dynamic',
    component: () => import('@/views/activity/dynamic'),
  },
